...
#    Updated: 2018/06/21 07:11:30 by wseegers         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = get_info.c get_numbers.c create_stack.c e_exit.c stack_print.c\
	  ...
	  create_state.c next_state.c stack_equ.c state_equ.c excl_append_state.c\
	  print_stacks_line.c graph_search.c h_cost.c
BIN_PATH = bin
